...
public class VirtualPetTest {
    ...
    @Test public void increaseHungerShouldIncreaseHungerLevel(){
    ...
    @Test public void increaseThirstShouldIncreaseThirstLevel(){
        VirtualPet underTest = new VirtualPet("test", "test", 50,50,50,50);
    ...
    @Test public void increaseBoredomShouldIncreaseBoredomLevel(){
        VirtualPet underTest = new VirtualPet("test", "test", 50,50,50,50);
    ...
    @Test public void decreaseHungerShouldDecreaseHungerLevel(){
        VirtualPet underTest = new VirtualPet("test", "test", 50,50,50,50);
        int initial = underTest.getHungerLevel();
        int n = 1;
    ...
    @Test public void decreaseThirstShouldDecreaseThirstLevel(){
        VirtualPet underTest = new VirtualPet("test", "test", 50,50,50,50);
        int initial = underTest.getThirstLevel();
        int n = 1;
    ...
    @Test public void decreaseBoredomShouldDecreaseBoredomLevel(){
        VirtualPet underTest = new VirtualPet("test", "test", 50,50,50,50);
        int initial = underTest.getBoredomLevel();
        int n = 1;
